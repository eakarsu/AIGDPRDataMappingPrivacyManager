...
`systems` inventories with purpose, lawful basis, jurisdiction, classifications, lineage and versioned retention; DSRs with system scope, legal-hold exceptions and fulfillment evidence; consent and incident counts.

Classification/lineage/retention coverage and provable access, deletion, correction and export outcomes are deterministic. Legal interpretation, discovery false-negative measurement, data-catalog/IAM/ticketing/consent/legal-hold/deletion adapters and counsel validation remain blocked externally.
