...
// Auto-generated page for: No public-facing privacy portal for end users to file DSRs

export default function GapNoPublicFacingPrivacyPortalFor() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-public-facing-privacy-portal-for', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No public-facing privacy portal for end users to file DSRs</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No public-facing privacy portal for end users to file DSRs</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No public-facing privacy portal for end users to file DSRs'}
        </button>
      </form>
