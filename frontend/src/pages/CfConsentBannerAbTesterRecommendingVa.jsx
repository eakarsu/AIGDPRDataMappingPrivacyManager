...
// Auto-generated page for: Consent banner A/B tester recommending variants that maximiz

export default function CfConsentBannerAbTesterRecommendingVa() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-consent-banner-ab-tester-recommending-va', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Consent banner A/B tester recommending variants that maximiz</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Consent banner A/B tester recommending variants that maximize legitimate consent without dark patterns.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Consent banner A/B tester recommending variants that maximiz'}
        </button>
      </form>
