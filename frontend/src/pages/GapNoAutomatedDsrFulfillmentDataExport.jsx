...
// Auto-generated page for: No automated DSR fulfillment (data export / anonymization ru

export default function GapNoAutomatedDsrFulfillmentDataExport() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-automated-dsr-fulfillment-data-export', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No automated DSR fulfillment (data export / anonymization ru</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No automated DSR fulfillment (data export / anonymization runner)</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No automated DSR fulfillment (data export / anonymization ru'}
        </button>
      </form>
