...
// Auto-generated page for: No automated DPA contract template generator from PIA inputs

export default function GapNoAutomatedDpaContractTemplateGener() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-automated-dpa-contract-template-gener', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No automated DPA contract template generator from PIA inputs</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No automated DPA contract template generator from PIA inputs</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No automated DPA contract template generator from PIA inputs'}
        </button>
      </form>
