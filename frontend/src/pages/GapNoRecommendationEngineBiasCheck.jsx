...
// Auto-generated page for: No recommendation-engine bias check

export default function GapNoRecommendationEngineBiasCheck() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-recommendation-engine-bias-check', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No recommendation-engine bias check</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No recommendation-engine bias check</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No recommendation-engine bias check'}
        </button>
      </form>
