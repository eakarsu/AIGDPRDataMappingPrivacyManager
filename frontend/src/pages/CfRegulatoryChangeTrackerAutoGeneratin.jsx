...
// Auto-generated page for: Regulatory change tracker auto-generating gap assessments fr

export default function CfRegulatoryChangeTrackerAutoGeneratin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-regulatory-change-tracker-auto-generatin', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Regulatory change tracker auto-generating gap assessments fr</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Regulatory change tracker auto-generating gap assessments from regulatoryTracker feed.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Regulatory change tracker auto-generating gap assessments fr'}
        </button>
      </form>
