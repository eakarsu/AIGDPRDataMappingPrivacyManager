// Custom visualization feature for AI GDPRData Mapping Privacy Manager.
...
export function TimelineView(container) {
  ...
  const svg = `
    <section style="font-family: Inter, system-ui, sans-serif; color: #172033; padding: 24px;">
      ...
      <h1 style="margin:6px 0 18px;font-size:30px">AI GDPRData Mapping Privacy Manager Timeline View</h1>
